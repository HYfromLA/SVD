function [vStats, NoiseSigma] = EstimateDim_LargestMultiscaleGap( cX, cData, cOpts )
...
if ~cOpts.Ptwise
    ...
    [vStats, NoiseSigma] = EstimateDimFromSpectra( cData.NetsOpts.Delta', lVolumes, cOpts, lMeanS );
else
    GoodScales{lN} = [];
    DimEst(lN)     = 0;
    for k = 1:lN
        ...
        [lStats, NoiseSigma] = EstimateDimFromSpectra( cData.NetsOpts.Delta', lVolumes, cOpts, lS );
